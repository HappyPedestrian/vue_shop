...
try {
    ...
    $preSqls = $conn->prepare("UPDATE `category` set cate_name=".$quote.$cate_name.$quote.",cate_delete=".$cate_delete.",cate_level=".$cate_level." WHERE cate_id=".$cate_id);
