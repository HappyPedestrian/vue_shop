...
if(property_exists($data, 'attr_vals')){
...
try {
    ...
    $insertPreSqls = $conn->prepare("INSERT INTO `attrs` (attr_name,cate_id,attr_sel) VALUES ('".$attr_name."',".$cate_id.",'".$attr_sel."')");
